...
INSERT INTO funcionarios (adicional_periculosidade, ajuda_de_custo, dependentes, funcao, horas_extras, jornada_de_trabalho, nome, salario, valor_plano_de_saude, cpf, tipo) VALUES (0.3, 300.00, 2, "Desenvolvedor Jr.", 10, 176, "Jerry", 3500.00, 50.00,"22233344480", "COLABORADOR")
UPDATE funcionarios SET empresa_id = 1 WHERE id = 1

INSERT INTO funcionarios (adicional_periculosidade, ajuda_de_custo, dependentes, funcao, horas_extras, jornada_de_trabalho, nome, salario, valor_plano_de_saude, empresa_id, cpf, tipo) VALUES (0.3, 300.00, 0, "Desenvolvedor Pleno", 20, 176, "Kramer", 6500.00, 50.00, 1, "33333333360", "COLABORADOR")
